...
pgd = PGD(attack_model=classifier, surrogate_model=grad_calc, algorithm="PRGF-GA", sigma=0.1)

res = pgd.attack(image_np, label=true_label,stop_iter=1000, eps=0.9 , q=10, lr=0.01)
