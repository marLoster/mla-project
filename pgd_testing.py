...
pgd = PGD(attack_model=classifier, surrogate_model=grad_calc, algorithm="PRGF-BS", sigma=0.0001)

res = pgd.attack(image_np, label=true_label,stop_iter=1000, eps=10, q=10, lr=0.1)
